...
|---|---|---|---|---|---|
| A57-EDP | `A57`, `a57`, `eDP`, `EDP`, `edp`, `DS90UB984`, `984`, `AUX`, `HPD`, `CR`, `EQ`, `CR/EQ`, `EQ/CR`, `训练字`, `SerDes`, `AU15P`, `Redriver`, `解码板`, `不出图`, `出图异常` | `pilot_runs/a57_edp/visual-architecture-brief.md`; `pilot_runs/a57_edp/latest-input-cleaning.md`; `pilot_runs/a57_edp/latest-architecture-first.md`; `pilot_runs/a57_edp/field-action-plan.md` | active unresolved pilot case | 2026-05-13 | Treat short follow-ups as evidence updates. For CR/EQ fail, update Mode A AUX/DPCD training-control branch first. |
| RTL8370-SWITCH-LOSS | `RTL8370`, `switch`, `packet loss`, `丢包`, `long uptime`, `soak`, `MIB`, `CRC`, `queue`, `port` | `pilot_runs/rtl8370_switch_packet_loss/visual-architecture-brief.md`; `pilot_runs/rtl8370_switch_packet_loss/latest-input-cleaning.md`; `pilot_runs/rtl8370_switch_packet_loss/latest-architecture-first.md`; `pilot_runs/rtl8370_switch_packet_loss/field-action-plan.md` | synthetic dry-run, not promoted | 2026-05-13 | Use only as a governance/template exercise unless real evidence is added. |
