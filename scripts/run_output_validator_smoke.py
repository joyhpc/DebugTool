...
CASES = [
    ...
    ("architecture_first", "architecture_chinese_good.md", 0),
    ("architecture_first", "architecture_spell_words_bad_expected_fail.md", 1),
    ...
    ("evidence_audit", "evidence_audit_spell_words_bad_expected_fail.md", 1),
