...
|---|---|---|---|---|---|---|
| F1 | Rear video path sometimes has no image | user report | raw_artifact | high | fresh | video data path |
| F2 | AUX is confirmed alive | user report | raw_artifact | high | fresh | control path |
| F3 | SerDes CDR does not lock after reset | user report | raw_artifact | high | fresh | receiver CDR |
