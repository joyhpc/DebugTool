...
Video link intermittently fails. This fixture intentionally leaves a P0 action without a co-acquisition group.
...
|---|---|---|---:|---|
| M1 | mechanism | decoder state issue | 0.40 | B1 |
| M2 | observability_gap | missing decoder status | 0.20 | B0 |
...
|---|---|---|---|---|---|---|---|
| EV1 | decoder status | present | critical | B1 | M1 | status is available | none |
...
M1[M1 decoder state active 40 percent] -.-> B1
```
...
Not Applied: ungrouped P0 action.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|
| A1 | P0 | none | true | register_dump | Read decoder status | B1 | M1 | 0.20 | 0.40 | 20 |
...
Stop when validator rejects the ungrouped P0 row.
