...
Video link intermittently fails. This fixture intentionally tries to bypass an evidence cap with a prose-only local override.
...
|---|---|---|---|---|---|---|---|
| EV1 | decoder timing and status capture | missing | critical | B1 | M1 | missing evidence should cap M1 | override because indirect evidence from another board seems persuasive but no numeric cap/value is stated |
...
Not Applied: numeric local override format.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|
| A1 | P0 | CO-CAP-BAD | true | timing_capture | Standalone capture decoder timing | B1 | M1 | 0.20 | 0.40 | 20 |
...
Stop when validator rejects the prose-only local override.
